...
const MissionVision = () => {
  return (
    <section id="mission-vision" className="bg-gray-50 pt-4 pb-8 flex flex-col justify-center">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">Onze Missie en Visie</h2>
